...
export default function CameraScreen() {
      ...
      <SafeAreaView style={styles.container}>
        <View style={styles.permissionContainer}>
          ...
          <Text style={styles.permissionDesc}>
            O SnapPrice precisa da câmera para fotografar itens e estimar seus
            preços de mercado.
          </Text>
          <TouchableOpacity
  ...
  async function handleCapture() {
    ...
    try {
      ...
      // TODO Sprint 2: enviar photo.uri para o backend /analyze
      // Por ora, navega direto para a tela de resultado mock
      router.push('/result');
    } catch (error) {
    ...
    <View style={styles.container}>
      ...
      <SafeAreaView style={styles.topBar} edges={['top']}>
        ...
        <TouchableOpacity
          style={[
            styles.iconBtn,
            flash && { backgroundColor: tokens.colors.primary },
          ]}
      ...
      <View style={styles.hintContainer}>
        <Text style={styles.hintText}>
          Centralize o item dentro da área
        </Text>
      </View>
